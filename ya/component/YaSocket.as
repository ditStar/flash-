package ya.component
{
	...
	public class YaSocket extends Socket implements IDestroy
	{
		...
		private function firstHandshakeFun():void{
			...
			bodyObj.roomid = int(PlayerModel.instance.playerVo.room_id);
			bodyObj.uid = 100000000000000+Number((200000000000000 * Math.random()).toFixed(0));
			LogManager.log(MyJSON.encode(bodyObj));
			var b:ByteArray = new ByteArray();
			b.writeUTFBytes(MyJSON.encode(bodyObj));	
			sendsocketData(16+b.length,16,1,7,1,b);
		}
